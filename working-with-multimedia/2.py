...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.dir_icon = self.style().standardIcon(QStyle.StandardPixmap.SP_ArrowRight)
        ...
        self.urls = ["https://rusradio.hostingradio.ru/rusradio128.mp3", "http://online1.gkvr.ru:8000/radiola_srt_128.mp3", "http://nashe1.hostingradio.ru/jazz-128.mp3", "http://nostalgiafm.hostingradio.ru:8000/nostalgiafm.mp3", "http://icepe2.infomaniak.ch:80/swingfm-128.mp3"]
